...
@bot.command(
    name="fuel",
    help="""Devuelve el gasto de gasolina para la carrera.
    !fuel (Duración de la carrera o stint en minutos) (Tiempo por vuelta) (Fuel por vuelta)
    Ejemplo: !fuel 24 2:25:2 3.42""",
)
async def fuel(ctx, duration: int, lap_time: str, fuel_per_lap: float):
    ...
    response = (
        "<@{author}>, tu calculo de fuel es de: {fuel} Litros | Vueltas: {laps}".format(
